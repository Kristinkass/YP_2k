...
def show_rules():
    ...
    Зараженные клетки "x" становятся красными и переходят в подчинение нолику, а зараженные 
    ...
    Во время игры можно ПРОПУСТИТЬ свой ХОД при отсутствии допустимого хода/действия по мнению    
